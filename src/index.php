<?php
    ...
    $human1 = new Human('Igor', 32, 'm');

    $human2 = new Human('Egor', 17, 'm');
   // $human3 = new Human(sex:'m', name:'Ololo', age: 22);
    $human1->setName('wsdfsdfsdfdsfsd');

    $student = new Student('xzczxc', 23423, 'm');
    echo $student->sayHello();
    echo $student->sayAnswer();
